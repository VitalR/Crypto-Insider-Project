"""
Django settings for cryptoinsider_project project.
...
SECRET_KEY = 'wt&cq@p1g+f-dafuty%&u^l@_r*4qmkz+^_iymkplfaxyq^1^$'
...
ROOT_URLCONF = 'cryptoinsider_project.urls'
...
WSGI_APPLICATION = 'cryptoinsider_project.wsgi.application'
...
# User email password reset confirm
